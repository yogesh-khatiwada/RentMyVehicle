...
@section('body-content')
    ...
    <section class="section dashboard">
        <div>
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Add cars <a href="{{ route('bike.create') }}" class="btn btn-sm btn-primary">Add
                            New</a></h5>
                    <!-- Default Table -->
                    @if (session('success'))
                        ...
                        <tbody>
                            ...
                            @foreach ($bikes as $bike)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-secondary  class='bx bxs-edit'><"
                                            href="{{ route('bike.edit', $bike->id) }}" role="button">Edit</a>
