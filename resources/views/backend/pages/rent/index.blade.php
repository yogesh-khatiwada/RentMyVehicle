...
@section('body-content')
    ...
    <section class="section dashboard">
        <div>
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Rent Table</h5>
                        ...
                        <tbody>
                            @foreach ($rents as $rent)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-info" href="{{ asset($rent->resume) }}" target="_blank"><i
                                                class="fa fa-eye" aria-hidden="true"></i> View</a>
                                    </td>
                                    <td>
                                        <span class="">{{ $rent->car ? $rent->car->carName : '' }}</span>
                                    </td>
                                    <td>
