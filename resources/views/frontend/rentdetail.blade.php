                ...
                <div class="col-md-8 col-12">
                    ...
                    @if (Auth::user())
                        <form action="{{ route('car.rent.store', $car->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="resume">Licesence</label>
                            ...
                            <div class="form-group d-none">
                                ...
                                <input type="integer" value="{{ $car->prize }}" style="display:none" name="totalprice"
                            ...
                            {{-- <a href="{{ route('car.detail',$car->id) }}" class="btn btn-dark">Rent</a> --}}
                            <div>
                                <br>
