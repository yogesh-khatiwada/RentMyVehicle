            ...
            <div class="row">
                ...
                <div class="col-md-8 col-12">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item ">Resume: <a href="{{ asset($bookedoffer->resume) }}"
                                target="_blank">Resume View <i class="fa fa-eye" aria-hidden="true"></i></a></li>
                        <li class="list-group-item ">Resume: <a href="{{ asset($bookedoffer->citizenship) }}"
                                target="_blank">citizenship View <i class="fa fa-eye" aria-hidden="true"></i></a></li>
                        <li class="list-group-item ">Resume: <a href="{{ asset($bookedoffer->citizenshipb) }}"
