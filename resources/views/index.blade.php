          ...
          <div class="col-md-4">
            ...
            <div class="service-item">
              ...
              <div class="down-content">
                <h5> Car Name: <span>httj</span></h5>
                <div style="margin-bottom:10px;">
                  <span>Car Model: khbhs </span><br>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="left-image">
                ...
                <img src="{{ asset('frontend/images/abou.jpg') }}" class="img-fluid" alt="">
              </div>
            </div>
          ...
          <div class="col-md-8">
            <section class='tabs-content'>
              <article id='tabs-1'>
                ...
                <p>The 600cc super bike, Honda CBR600RR is powered by Race-Ready liquid cooled DOHC 16-valve inline four-cylinder power plant.Inspired by ultimate racing machine Honda RC213V, CBR600RR is offers perfect balance of high-revving power, precise handling.CBR600RR evolve into one of the most polished packages ever produced in the Super Sports arena.</p>
              </article>
              <article id='tabs-2'>
                
                <img src="{{ asset('frontend/images/mustang.jpg') }}" alt="">
                <h4><a href="">Ford Mustang GT</a></h4>
                <p>Ford Mustang is one of the most popular sports cars in the world and now finally, it has arrived in Nepal. GO Automobiles, the official distributor of Ford Cars in Nepal, is going to soft launch Ford Mustang GT Fastback 2018 in the Nepali market on this Friday at its showroom located at Chabahil, Kathmandu. The Ford Mustang GT price in Nepal is set Rs. 1,70,00,000, (1.7 Cr) which is less than what we expected</p>
              </article>
              <article id='tabs-3'>
                
                <img src="{{ asset('frontend/images/vr.png') }}" alt="">
                <h4><a href="">Hartford VR 223</a></h4>
                <p>Probably the most famous bike of its generation, Hartford VR is one of the very first dirt bikes that made its way to Nepal. Since this was a new segment here, it rose to popularity in no time. There are still many people who follow Harford’s VR to this day.  
                </p>
              </article>
            </section>
          </div>
            ...
            <div class="owl-testimonials owl-carousel">
              ...
              <div class="testimonial-item">
                <div class="inner-content">
                  ...
                  <p>Thank you so much for providing best bike. All the service are better than other company."</p>
                </div>
