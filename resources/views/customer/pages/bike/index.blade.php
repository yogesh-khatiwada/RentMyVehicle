...
@section('body-content')
    ...
    <section class="section dashboard">
        <div>
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Add cars <a href="{{ route('customer.bike.create') }}"
                    ...
                    <table class="table">
                        ...
                        @foreach ($bikes as $bike)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-secondary" href="{{ route('customer.bike.edit', $bike->id) }}"

                                        role="button">Edit</a>
                                        <form action="{{ route('customer.bike.destroy', $bike->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
