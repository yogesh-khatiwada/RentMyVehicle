...
@section('body-content')
    ...
    <section class="section dashboard">
        <div>
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Add cars <a href="{{ route('customer.car.create') }}"
                    ...
                    <table class="table">
                        ...
                        @foreach ($cars as $car)
                            <tr style="{{$car->status =='notavailable'? 'background-color:red; color:#fff;':'' }}">
                                ...
                                <td>
                                    <a class="btn btn-secondary" href="{{ route('customer.car.edit', $car->id) }}"

                                        role="button">Edit</a>
                                        <form action="{{ route('customer.car.destroy', $car->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
